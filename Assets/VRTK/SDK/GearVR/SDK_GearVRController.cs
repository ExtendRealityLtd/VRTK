...
namespace VRTK
{
    ...
    public class SDK_GearVRController : SDK_BaseController
    {
        ...
        public override bool GetControllerButtonState(ButtonTypes buttonType, ButtonPressTypes pressType, VRTK_ControllerReference controllerReference)
        {
            ...
            switch (buttonType)
            {
                ...
                case ButtonTypes.Touchpad:
                    return GetControllerButtonState(dPadAlias, pressType);
                case ButtonTypes.ButtonOne:
                    return GetControllerButtonState(dPadAlias, pressType);
                case ButtonTypes.ButtonTwo:
                    return GetControllerButtonState(backButtonAlias, pressType);
        ...
        /// </summary>
        /// <param name="buttonAlias">The button alias to check.</param>
        ...
        protected virtual bool GetControllerButtonState( string buttonAlias, ButtonPressTypes pressType)
        {
            if (pressType == ButtonPressTypes.Touch)
            {
                return Input.GetButton(buttonAlias);
            }
            else if (pressType == ButtonPressTypes.TouchDown)
            {
                return Input.GetButtonDown(buttonAlias);
            }
            else if (pressType == ButtonPressTypes.TouchUp)
            {
                return Input.GetButtonUp(buttonAlias);
            }
