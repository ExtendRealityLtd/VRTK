namespace VRTK.Prefabs.Helpers.Tooltip
{
    ...
    public class TooltipFacade : MonoBehaviour
    {
        ...
        [Header("Container Settings"), Tooltip("The color of the background for the tooltip container."), SerializeField]
        ...
        [Tooltip("The size of the background for the tooltip container."), SerializeField]
