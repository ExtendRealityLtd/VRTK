...
{
    /// <summary>
    ///     The PlayStation Headset SDK script  provides  functions for the headset.
    /// </summary>
    [SDK_Description(typeof(SDK_PlayStationVRSystem))]
    public class SDK_PlayStationVRHeadset : SDK_BaseHeadset
    {
        ...
        public override Transform GetHeadset()
        {
            ...
            GameObject player = SDK_PlayStationVRInput.FindInScene();
            if (player)
            {
        ...
        /// <summary>
        ///     The GetHeadsetCamera/0 method returns the Transform of the object that is used to hold the headset camera in the
        ///     scene.
        /// </summary>
        ...
        AddHeadsetFade(GetHeadset());
            VRTK_ScreenFade fade = GetHeadset().GetComponent<VRTK_ScreenFade>();
            fade.StartFade(color,duration);
        }

        /// <summary>
        ///     The HasHeadsetFade method checks to see if the given game object (usually the camera) has the ability to fade the
        ///     viewpoint.
        /// </summary>
        ...
        {
            VRTK_ScreenFade fade = obj.GetComponent<VRTK_ScreenFade>();
            return fade != null;
        }
