...
namespace VRTK
{
    ...
    public partial class SDK_PlayStationVRController : SDK_BaseController
    {
        ...
        [Tooltip("sticky - the activator remains on until pressed again")] public bool Sticky;
        ...
        public SDK_PlayStationMoveController.PlayStationKeys TouchPadSimulationActivator =
            SDK_PlayStationMoveController.PlayStationKeys.Trigger;
        ...
        public SDK_PlayStationMoveController.PlayStationKeys TouchPadSimulationKey =
            SDK_PlayStationMoveController.PlayStationKeys.Cross;
        ...
        public virtual void SetKeyMappings(
            Dictionary<SDK_PlayStationMoveController.PlayStationKeys, KeyCode> givenKeyMappings)
        {
        ...
        {
#if UNITY_PS4
            PlayStationHapticPulseOnIndex(index, strength);
#endif
        }
        ...
        public override GameObject GetControllerModel(ControllerHand hand)
        {
            ...
            {
                case ControllerHand.Left:
                    model = leftController.transform.FindChild(HandName).gameObject;
                    break;
                case ControllerHand.Right:
                    model = rightController.transform.FindChild(HandName).gameObject;
                    break;
                case ControllerHand.None:
                    break;
                default:
        ...
        {
            return IsButtonPressed(index, ButtonPressTypes.Press, SDK_PlayStationMoveController.PlayStationKeys.Middle);
        }
        ...
        {
            return IsButtonPressed(index, ButtonPressTypes.PressDown,
                                   SDK_PlayStationMoveController.PlayStationKeys.Middle);
        }
        ...
        {
            return IsButtonPressed(index, ButtonPressTypes.Press, SDK_PlayStationMoveController.PlayStationKeys.Cross);
        }
        ...
        {
            return IsButtonPressed(index, ButtonPressTypes.Press, SDK_PlayStationMoveController.PlayStationKeys.Circle);
        }
        ...
        {
            return IsButtonPressed(index, ButtonPressTypes.PressDown,
                                   SDK_PlayStationMoveController.PlayStationKeys.Circle);
        }
        ...
        {
            return IsButtonPressed(index, ButtonPressTypes.Press, SDK_PlayStationMoveController.PlayStationKeys.Start);
        }
        ...
        {
            return IsButtonPressed(index, ButtonPressTypes.PressDown,
                                   SDK_PlayStationMoveController.PlayStationKeys.Start);
        }
        ...
        {
            return Input.GetKey(
                       rightController.GetControllerKey(SDK_PlayStationMoveController.PlayStationKeys.Triangle))
                   || Input.GetKey(
                       leftController.GetControllerKey(SDK_PlayStationMoveController.PlayStationKeys.Triangle));
        }
        ...
        {
            return Input.GetKey(rightController.GetControllerKey(SDK_PlayStationMoveController.PlayStationKeys.Square))
                   || Input.GetKey(
                       leftController.GetControllerKey(SDK_PlayStationMoveController.PlayStationKeys.Square));
        }
        ...
        private bool IsButtonPressed(uint index, ButtonPressTypes type,
                                     SDK_PlayStationMoveController.PlayStationKeys playStationKey)
        {
        ...
        private void OnEnable()
        {
            ...
            List<SDK_PlayStationMoveController> controllers =
                new List<SDK_PlayStationMoveController>(
                    simPlayer.GetComponentsInChildren<SDK_PlayStationMoveController>());
            rightController =
                controllers.Find(e => e.ControllerType == SDK_PlayStationMoveController.Controller.Primary);
            leftController = controllers.Find(e => e.ControllerType
                                                   == SDK_PlayStationMoveController.Controller.Secondary);
        }
    }
}