namespace VRTK
{
...
#endif
    {
        ...
        {
            WindowsMR_ControllerVisualizer controllerVisualizer = null;
            switch (hand)
            {
                case ControllerHand.Left:
                    controllerVisualizer = GetControllerLeftHand(true).GetComponent<WindowsMR_ControllerVisualizer>();
                    break;
                case ControllerHand.Right:
                    controllerVisualizer = GetControllerRightHand(true).GetComponent<WindowsMR_ControllerVisualizer>();
                    break;
            }

            return controllerVisualizer.GetPathToButton(element);
        }
        ...
        {
            WindowsMR_ControllerVisualizer leftHandVisualizer = GetControllerLeftHand(true).GetComponent<WindowsMR_ControllerVisualizer>();
            WindowsMR_ControllerVisualizer rightHandVisualizer = GetControllerRightHand(true).GetComponent<WindowsMR_ControllerVisualizer>();

            if (leftHandVisualizer)
            {
                leftHandVisualizer.OnControllerModelLoaded += SetControllerModelReady;
            }

            if (rightHandVisualizer)
            {
                rightHandVisualizer.OnControllerModelLoaded += SetControllerModelReady;
            }
        }

        private void SetControllerModelReady(InteractionSourceHandedness handedness)
        {
