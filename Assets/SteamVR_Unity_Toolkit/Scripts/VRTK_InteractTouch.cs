    ...
    public class VRTK_InteractTouch : MonoBehaviour
    {
        ...
        private void OnTriggerStay(Collider collider)
        {
            ...
            if (touchedObject == null && IsObjectInteractable(collider.gameObject))
            {
                ...
                {
                    if (events.grabToggleButton != touchedObjectScript.GrabButton && touchedObjectScript.GrabButton != VRTK_ControllerEvents.ButtonAlias.Undefined)
                        events.grabToggleButton = touchedObjectScript.GrabButton;
                    else if (touchedObjectScript.GrabButton == VRTK_ControllerEvents.ButtonAlias.Undefined)
                        events.grabToggleButton = events.GgrabToggleButton;
                    if (events.useToggleButton != touchedObjectScript.UseButton && touchedObjectScript.UseButton != VRTK_ControllerEvents.ButtonAlias.Undefined)
                        events.useToggleButton = touchedObjectScript.UseButton;
                    else if (touchedObjectScript.UseButton == VRTK_ControllerEvents.ButtonAlias.Undefined)
