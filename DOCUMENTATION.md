...
#### Grab Options
  ...
  * **Ignore Kinematic:** Ignore the old Kinematic value of the object. If this option is checked the kinematic value will stay false when the object is throwed.
