...
namespace VRTK
{
    ...
    public class VRTK_SDKManager : MonoBehaviour
    {
        ...
        [Tooltip("A reference to the GameObject that models for the Left Hand Controller. If using XimmerseVR, please use _VisibleObject as model alias.")]
        public GameObject modelAliasLeftController;
		[Tooltip("A reference to the GameObject that models for the Right Hand Controller. If using XimmerseVR, please use _VisibleObject as model alias." )]
