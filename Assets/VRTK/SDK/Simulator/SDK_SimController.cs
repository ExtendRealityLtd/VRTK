...
namespace VRTK
{
    ...
    public class SDK_SimController : SDK_BaseController
    {
        ...
        {
            GameObject controller = GameObject.Find("VRTK_SimPlayer").transform.FindChild("LeftHand").gameObject;
            return controller;
        }
        ...
        {
            GameObject controller = GameObject.Find("VRTK_SimPlayer").transform.FindChild("RightHand").gameObject;
            return controller;
        }
